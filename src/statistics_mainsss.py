...
expert_victories = {}
pro_victories = {}
FoodSeekerAgentwithAstar_victories = {}
...
def run_multiple_simulations(
    ...
    for i in range(num_simulations):
        ...
        expert_victories[i] = 0
        pro_victories[i] = 0
        FoodSeekerAgentwithAstar_victories[i] = 0
        ...
        for agent_id, handler in winner_agents.items():
            ...
            elif type(handler.agent).__name__ == "ExpertAgent":
                expert_victories[i] += 1
            elif type(handler.agent).__name__ == "ProAgent":
                pro_victories[i] += 1
            elif type(handler.agent).__name__ == "FoodSeekerAgentwithAstar":
                FoodSeekerAgentwithAstar_victories[i] += 1
...
def plot_and_save(num_simulations, map_width, map_height, num_agents):
    ...
    def plot_victories_by_type_and_simulation(
        ...
        df = pd.DataFrame(
            {
                ...
                "ExpertAgent": expert_victories,
                "ProAgent": pro_victories,
                "FoodSeekerAgentwithAstar": FoodSeekerAgentwithAstar_victories,
            }
        )
        ...
        plt.plot(
            df.index,
            df["FoodSeekerAgentwithAstar"],
            label="FoodSeekerAgentwithAstar",
            linestyle="-",
            color="black",
        )
